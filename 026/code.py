# -*- coding: utf-8 -*-
"""
LC Problem 26 Remove Duplicates from Sorted Array
...
languages, you must instead have the result be placed
...
class Solution:
    def removeDuplicates(self, nums: List[int]) -> int:
        ...
        # How many elements we still need to check
        num_remain = len_nums - 1
        
        while num_remain > 0:
            #print(nums, num_remain, cur_index)
            elem = nums[cur_index]
            if prev == elem:
                # Delete this duplicate from the list
                del(nums[cur_index])
...
rez = Solution.removeDuplicates(class_instance, nums)   
print(rez, nums)     
